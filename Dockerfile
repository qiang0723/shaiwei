...
COPY compose.yaml compose.research.yaml compose.m6-attribution.yaml compose.m6-topk-conversion-release.yaml compose.ts-recovery.yaml compose.ts-v5-llm.yaml compose.ts-v5-r2.yaml compose.ts-v5-r3c.yaml compose.ts-v5-r3f.yaml compose.ts-v5-r3g.yaml compose.ts-v5-r3g1.yaml compose.ts-v5-r3g2-benchmark.yaml compose.ts-v5-r3g2-w7.yaml compose.ts-v5-r3g2-w7-recovery.yaml compose.ts-v5-r3g2-effect.yaml compose.ts-v5-r3g2-effect-recovery.yaml ./
COPY src ./src
COPY config ./config
