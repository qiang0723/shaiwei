...
COPY .dockerignore .env.example Dockerfile Dockerfile.ts-v5-llm Dockerfile.ts-v5-r3g Dockerfile.ts-v5-r3g1 Dockerfile.ts-v5-r3g2-benchmark Dockerfile.ts-v6-entry-quality Dockerfile.ts-v6-1-ranking Dockerfile.ts-v6-3-ranked-subset Dockerfile.ts-v6-4-no-takeprofit Dockerfile.ts-b-holdout Dockerfile.ts-rf-0b Dockerfile.ts-rf-diag Dockerfile.ts-rf-0c Dockerfile.ts-rf-1 Dockerfile.ts-c-qualification Dockerfile.ts-c-qualification-v2 Makefile pyproject.toml requirements.lock requirements.ts-v5-llm.lock ./
COPY compose.yaml compose.research.yaml compose.m6-attribution.yaml compose.m6-topk-conversion-release.yaml compose.m6-production-head30-release.yaml compose.m6-production-head30-recovery.yaml compose.m6-production-head30-price-recovery.yaml compose.m6-head30-500k-release.yaml compose.m6-head30-500k-entrypoint-recovery.yaml compose.ts-recovery.yaml compose.ts-v5-llm.yaml compose.ts-v5-r2.yaml compose.ts-v5-r3c.yaml compose.ts-v5-r3f.yaml compose.ts-v5-r3g.yaml compose.ts-v5-r3g1.yaml compose.ts-v5-r3g2-benchmark.yaml compose.ts-v5-r3g2-w7.yaml compose.ts-v5-r3g2-w7-recovery.yaml compose.ts-v5-r3g2-effect.yaml compose.ts-v5-r3g2-effect-recovery.yaml compose.ts-v5-r3g3-diagnostic.yaml compose.ts-v6-entry-quality.yaml compose.ts-v6-1-ranking.yaml compose.ts-v6-3-ranked-subset.yaml compose.ts-v6-4-no-takeprofit.yaml compose.ts-b-holdout.yaml compose.ts-rf-0b.yaml compose.ts-rf-diag.yaml compose.ts-rf-0c.yaml compose.ts-rf-1.yaml compose.ts-c-qualification.yaml compose.ts-c-qualification-v2.yaml ./
COPY src ./src
COPY config ./config
