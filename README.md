...
- 施工守则：CLAUDE.md ｜ 当前状态：STATE.md ｜ 结果路线图：docs/ROADMAP.md ｜ 口径卡：docs/DATA_SPEC.md ｜ 哨兵：docs/SENTINELS.md ｜ 判据：docs/GATES.md ｜ 日程：docs/DAY_PLAN.md ｜ 产品篮子：docs/FUND_COMPARATOR_SPEC.md
