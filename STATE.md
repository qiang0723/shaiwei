...
- [x] 离线质量门：96 项测试、Ruff、compileall、pip check、账本追加约束通过（2026-07-15；不等同真实数据验收）
...
- [ ] Day 5：财务三表逐股采集安全断点 6,115/16,335 个唯一请求（37.44%，325,707 行）；新增 2016Q1-2026Q2 三表 VIP 按季度 type 5 补采计划 126 请求，真实源端已验证三接口完整返回冻结字段（20221231 样本分别 404/500/312 行）；完成后跑 `688502.SH/20221231` 更正前后 PIT 实测
