...
## 2026-08-02 · M3-3机械Top2独立审查协议已结果前冻结
...
- 当前`execution_authorized=false`，只允许继续断网fixture、专属空账本与不可变预执行真身；真实
  DeepSeek调用须在预执行GO后按固定载荷、恰好8次和`$0.25`上限另获明确授权。验证/G1/模型/回测/
  信号/生产继续封存。见`docs/M3_MULTI_POOL_FACTOR_REVIEW_PROTOCOL_20260802.md`。
