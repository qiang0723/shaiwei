...
- [x] Day 7：AlphaGen CPU 中性化 benchmark 已真实完成；CSI300 单轮 100 候选总耗时 68.10 秒（setup 16.38 秒、evolution 51.71 秒），峰值 RSS 5,402,198,016 bytes，最佳 Rank IC 0.129759，结论 `scale_stage1`
