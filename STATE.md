...
## 待答点
- M1-0多股票池底座已GO；M1-1科创50价量因子批的协议、执行授权、预算、发现/封存窗口和语义门已
  在结果前冻结并完成零调用验收，下一动作仅为恰好40个DeepSeek完成响应与发现期机械Top2。
  科创100/200、科创综指和规则型池仍先过各自数据门；M1-1不得调优旧P2基线或读取验证/G1结果。
