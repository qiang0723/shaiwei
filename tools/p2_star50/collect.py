"""Collect immutable Star50 index history after a two-query stability probe."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--start-date", type=_parse_date, default=date(2019, 12, 31))
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = {
        ...
        "request_count": len(plan),
        "new_request_count": (
            int(existing_report["new_request_count"])
